...
const App: React.FC = () => {
  ...
  return (
    <div className="min-h-screen flex flex-col items-center px-1 md:px-1 font-outfit overflow-hidden bg-slate-20/50">
      <style>
        {`
      ...
      <header className="mb-4 text-center z-10">
        <div className="flex items-center justify-center gap-3 mb-1">
          <Cloud className="fill-sky-100 text-sky-300 w-8 h-8" strokeWidth={2.5} />
          <h1 className="font-fredoka font-semibold text-4xl tracking-tight bg-gradient-to-r from-sky-300 via-purple-300 to-rose-300 bg-clip-text text-transparent drop-shadow-sm leading-none pb-0">
            Pastel Memories
          </h1>
          <Cloud className="fill-rose-100 text-rose-300 w-8 h-8" strokeWidth={2.5} />
        </div>
        <p className="text-slate-400 font-bold tracking-[0.3em] uppercase text-[10px]">
          Your moments, softly captured
        </p>
      </header>

      <div className="transform scale-[0.85] origin-top -mt-4 w-full flex justify-center">
        <main className="w-full max-w-6xl grid grid-cols-1 lg:grid-cols-2 gap-16 items-start mt-10">
